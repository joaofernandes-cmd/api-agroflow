...
A execução de `npm test -- --coverage` demonstrou que a camada `backend/services` atingiu **86.22% de statements**, **76.77% de branches**, **90.69% de functions** e **86.26% de lines**, superando o mínimo de 80% exigido para a seção em statements, functions e lines. Os testes cobrem os principais serviços do sistema, incluindo autenticação, movimentações, sincronização, evidências, tarefas, tickets, validações e relatórios.
...
<div align="center">
  <p align="center">Figura 62 - Cobertura de testes da camada de services</p>
