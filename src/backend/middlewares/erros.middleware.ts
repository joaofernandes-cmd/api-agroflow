...
// Erro padronizado da aplicação, com status HTTP e detalhes extras
...
// Middleware final da cadeia: transforma qualquer erro em resposta HTTP consistente
export function tratadorDeErros(
  ...
  // Se a resposta já foi iniciada, não tenta enviar outra
  if (res.headersSent) {
    return
  }
